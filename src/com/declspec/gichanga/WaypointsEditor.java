package com.declspec.gichanga;
	...
	* @version $Id: WaypointsEditor.java 1 2011-07-16 23:22:47Z dcollins $
	* @see gov.nasa.worldwind.util.measure.MeasureTool
	*/
	public class WaypointsEditor extends JPanel	{
	    ...
	    public WaypointsEditor(WorldWindow wwdObject, MeasureTool measureToolObject)
	    {
